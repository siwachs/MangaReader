...
const contentInteractionButtonTextClasses =
  "font-noto-sans-sc ml-2.5 hidden h-[29px] text-base/[29px] font-[500] md:inline-block";

export { contentInteractionButtonClasses, contentInteractionButtonTextClasses };
